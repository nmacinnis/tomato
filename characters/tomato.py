...
_ABILITIES = [
    ...
    ("Deathless Nature", "passive", None, None, None,
    ...
    ("Knowledge from a Past Life", "free_action", 4, "long", "d6",
    ...
    ("Know Your Enemy", "bonus_action", 1, "long", None,
    ...
    ("Indomitable", "free_action", 1, "long", None,
    ...
    ("Tactical Shift", "passive", None, None, None,
    ...
    ("Tactical Master", "passive", None, None, None,
    ...
    ("Superiority Dice Pool (d8)", "free_action", 4, "short", "d8",
    ...
    ("Maneuver: Goading Attack", "action", None, None, None,
    ...
    ("Maneuver: Rally", "bonus_action", None, None, None,
    ...
    ("Maneuver: Riposte", "reaction", None, None, None,
    ...
    ("Maneuver: Precision Attack", "action", None, None, None,
    ...
    ("Maneuver: Parry", "reaction", None, None, None,
    ...
    # Feats
    ("Feat — Mage Slayer: Guarded Mind", "free_action", 1, "short", None,
    ...
    ("Feat — Mage Slayer: Concentration Breaker", "passive", None, None, None,
    ...
    ("Feat — Sentinel: Guardian", "reaction", None, None, None,
    ...
    ("Feat — Sentinel: Halt", "passive", None, None, None,
    ...
    ("Spell: Goodberry", "action", 1, "long", None,
    ...
    # Background
    ("Rustic Hospitality", "passive", None, None, None,
    ...
    # Weapon Mastery
    ("Weapon Mastery: Spear (Sap)", "passive", None, None, None,
     "On a hit with a Spear, the target has Disadvantage on its next attack roll before "
     "the start of your next turn."),

    ("Weapon Mastery: Hand Axe (Vex)", "passive", None, None, None,
    ...
    ("Weapon Mastery: Javelin (Slow)", "passive", None, None, None,
     "On a hit with a Javelin, the target's Speed is reduced by 10 ft until the start "
     "of your next turn."),

    ("Weapon Mastery: Halberd (Cleave)", "passive", None, None, None,
...
_ITEMS = [
    ...
    ("Crowbar", 1, 5.0,
     "Useful for prying things open. Advantage on Str checks where applicable.", False),
...
def apply(conn):
    ...
    cid = conn.execute(
        "SELECT id FROM characters WHERE name=?", (_NAME,)
    ).fetchone()[0]
    ...
    weapons = [
        ...
        ("Yester Hill Axe","1d8",  "slashing", 1, 1,
         "Versatile (1d10), +1d8 vs animals/plants/monstrosities"),
    ]
